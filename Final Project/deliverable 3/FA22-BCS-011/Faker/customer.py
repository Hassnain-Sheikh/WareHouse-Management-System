...
def generate_sql_queries(num_entries):
    ...
    for i in range(1, num_entries + 1):
        ...
        query = f"EXEC InsertCustomer @CustomerID = {i}, @CustomerName = '{name}', @CustomerPhone = '{phone}', @CustomerEmail = '{email}', @Street = '{street}', @City = '{city}', @State = '{state}', @PostalCode = '{postal_code}', @Country = '{country}';"
