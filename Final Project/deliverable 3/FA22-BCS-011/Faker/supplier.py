...
def generate_sql_queries(num_entries):
    ...
    for i in range(1, num_entries + 1):
        ...
        query = f"EXEC InsertSupplier @SupplierID = {i}, @SupplierName = '{name}', @SupplierPhone = '{phone}', @SupplierEmail = '{email}', @Street = '{street}', @City = '{city}', @State = '{state}', @PostalCode = '{postal_code}', @Country = '{country}';"
